...
var $at = __webpack_require__(41)(true); // 21.1.3.27 String.prototype[@@iterator]()
...
var defined = __webpack_require__(16); // true  -> String#at
...
var iconfont = __webpack_require__(74);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("/song/url?id=".concat(id)).then(function (res) {
              return res.json();
            });
